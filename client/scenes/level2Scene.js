...
//========================= DRAW LOOP =========================
function drawLevel2(ctx, canvas, deltaTime){  //TODO DRAW MUST CHANGE TO CAMERA VIEW
...
//========================= UPDATE LOGIC =========================
function update(deltaTime, canvas){
    if (!player) return; //avoids crash
...
//========================= INPUT HANDLERS =========================
function handleMouseMoveLevel2(event, canvas){
